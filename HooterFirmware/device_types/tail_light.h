...
#define DATA_PIN            5       // Main LED strip pin
#define BUTTON_PIN          10       // Set to 0 to disable
#define BRIGHTNESS_PIN      0       // Set to 0 to disable
#define LED_TYPE            WS2812  // LED type (WS2812, WS2811, SK6812, etc.)
#define COLOR_ORDER         GRB     // Use red() green() blue() to validate color order
#define NUM_LEDS            241     // Number of LEDs
#define BRIGHTNESS          255     // 0 to 255
#define FRAMES_PER_SECOND   120      // Set to 0 to disable throttle
